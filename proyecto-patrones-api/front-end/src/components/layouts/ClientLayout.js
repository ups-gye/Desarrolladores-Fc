...
const ClientLayout = () => {
    ...
    return (
        <div className="flex">
            {/* Sidebar */}
            <aside
                className={`${isSidebarOpen || window.innerWidth >= 768 ? 'block' : 'hidden'
                    } w-64 bg-gray-800 text-white p-6 flex flex-col h-screen`}
            >
                <div className="flex-grow">
                    ...
                    <nav className="mt-4 space-y-2">
                        ...
                        <Link to="habitaciones-disponibles" className="block hover:bg-gray-700 p-2 rounded">Habitaciones</Link>
                        <Link to="mis-reservas" className="block hover:bg-gray-700 p-2 rounded">Mis Reservas</Link>
                    </nav>
                </div>
                {/* Logout Button */}
                <div className="mt-4">
